  ...
  return (
    <div className={className || "h-[345px] overflow-clip relative w-[329px]"} data-name="Large / Calendar">
      ...
      <div className="absolute contents left-[171px] top-[14px]" data-name="Mini Calendar">
        <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[171px] not-italic text-[#ee5c51] text-[12px] top-[14px] whitespace-nowrap">JUNE</p>
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[173px] not-italic text-[10px] text-center top-[123px]" data-name="Week 5">
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[173px] not-italic text-[10px] text-center top-[104px]" data-name="Week 4">
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[173px] not-italic text-[10px] text-center top-[85px]" data-name="Week 3">
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[173px] not-italic text-[10px] text-center top-[67px]" data-name="Week 2">
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[193px] not-italic text-[10px] text-center top-[48px]" data-name="Week 1">
        ...
        <div className="[word-break:break-word] absolute contents font-['SF_Pro_Text:Medium',sans-serif] leading-[0] left-[173px] not-italic text-[9px] text-[rgba(0,0,0,0.5)] text-center top-[30px]" data-name="Week Days">
      ...
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[16px] not-italic text-[#ee5c51] text-[12px] top-[15px] whitespace-nowrap">Monday</p>
      <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Light',sans-serif] leading-[normal] left-[13px] not-italic text-[42px] text-black top-[24px] whitespace-nowrap">22</p>
      <div className="absolute contents left-[16px] top-[186px]">
        <div className="absolute contents left-[16px] top-[256px]" data-name="Event 2">
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[12px] text-black top-[276px] whitespace-nowrap">Video call</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[12px] text-[rgba(0,0,0,0.5)] top-[292px] whitespace-nowrap">15:30-16:00</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[normal] left-[24px] not-italic text-[15px] text-black top-[256px] whitespace-nowrap">Product meeting</p>
        ...
        <div className="absolute contents left-[173px] top-[256px]" data-name="Event 3">
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[181px] not-italic text-[12px] text-black top-[276px] whitespace-nowrap">Private</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[181px] not-italic text-[12px] text-[rgba(0,0,0,0.5)] top-[292px] whitespace-nowrap">15:30-16:00</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[normal] left-[181px] not-italic text-[15px] text-black top-[256px] whitespace-nowrap">Brainstorming</p>
        ...
        <div className="absolute contents left-[173px] top-[186px]" data-name="Event 1">
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[181px] not-italic text-[12px] text-black top-[206px] whitespace-nowrap">Video call</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[181px] not-italic text-[12px] text-[rgba(0,0,0,0.5)] top-[222px] whitespace-nowrap">12:30-13:00</p>
          <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[normal] left-[181px] not-italic text-[15px] text-black top-[186px] whitespace-nowrap">Design meeting</p>
      ...
      <div className="absolute contents left-[16px] top-[160px]" data-name="Event 1">
        <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[12px] text-black top-[204px] whitespace-nowrap">Online</p>
        <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[24px] not-italic text-[12px] text-[rgba(0,0,0,0.5)] top-[220px] whitespace-nowrap">10:00-11:30</p>
        <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Semibold',sans-serif] leading-[normal] left-[24px] not-italic text-[15px] text-black top-[184px] whitespace-nowrap">Apple Keynote</p>
        <p className="[word-break:break-word] absolute font-['SF_Pro_Text:Medium',sans-serif] leading-[normal] left-[16px] not-italic text-[12px] text-[rgba(0,0,0,0.5)] top-[160px] whitespace-nowrap">Today</p>
